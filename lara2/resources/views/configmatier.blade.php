    ...
    <main onclick="hideall()">
        ...
        <form class="mail" method="POdST">
            ...
            <div class="mail-title">
                <div class="text">
                    <p>config-matier</p>
                    <span>config / config-matier</span>
                </div>
        ...
        <section class="show-form div-salle" id="add-form1">
            ...
            <form method="POSTt" class="div" id="div-matier">
                ...
                <p id="p1">new matier</p>
                <p id="p2">project work involves a group of students investigating</p>
                <p id="p3">matier :<input type="text" placeholder="Option" id="i1" required></p>
                <p id="p5">niveau :
                    <select name="srearch" id="csearch">
                        <option value="1">nom</option>
        ...
        <section class="show-form div-matier" id="add-form2">
