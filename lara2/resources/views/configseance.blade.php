    ...
    <main onclick="hideall()">
        ...
        <form class="mail" method="POdST">
            ...
            <div class="mail-title">
                <div class="text">
                    <p>config-seance</p>
                    <span>config / config-seance</span>
                </div>
            ...
            <div class="tab">
                ...
                <ul>
                    ...
                    <li>
                        <p>#00001</p>
                        <p id="nom">s1g1</p>
                        <p id="email">28/03/2210</p>
                        <p >salle 1</p>
                        <p id="adresse"> oussama berhayla</p>
                        <p>math 2 bac</p>
                        <ul id="action">
        ...
        <section class="show-form div-prof" id="add-form1">
            ...
            <form method="POSTt" class="div" id="div-matier">
                ...
                <p id="p1">new seance</p>
                <p id="p2">project work involves a group of students investigating</p>
                <p id="p3">mom  :<input type="text" placeholder="Option" id="i1" required></p>
                <p id="p4" class="i-date">date :<input type="date" placeholder="email" id="i1" required></p>
                <p id="p5">salle :
                    <select name="srearch" id="csearch">
                        <option value="1">nom</option>
        ...
        <section class="show-form div-prof" id="add-form2">
            ...
            <form method="POSTt" class="div" id="div-matier">
                ...
                <p id="p1">update seance</p>
                <p id="p2">project work involves a group of students investigating</p>
                <p id="p3">mom  :<input type="text" placeholder="Option" id="i1" required></p>
                <p id="p4">date :<input type="date" placeholder="email" id="i1" required></p>
                <p id="p5">salle :
                    <select name="srearch" id="csearch">
                        <option value="1">nom</option>
                        <option value="1">prenom</option>
