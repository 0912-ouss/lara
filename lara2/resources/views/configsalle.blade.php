...
<body>
    ...
    <main onclick="hideall()">
        ...
        <section class="show-form div-salle" id="add-form1">
            ...
            <form method="POSTt" class="div" id="div-matier">
                ...
                <p id="p3">nom :<input type="text" placeholder="nom" id="i1" required></p>
                <p id="p4">capacite :<input type="text" placeholder="capacite" id="i1" required></p>
                <p id="p6">desc:<input type="text" placeholder="desc" id="i1" required></p>
